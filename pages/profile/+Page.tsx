...
const AddressSelector = React.lazy(() =>
  import("../../component/profile/AddressSelector").then((module) => ({
    default: module.AddressSelector,
  }))
);
const PersonalInfo = React.lazy(() =>
  import("../../component/profile/PersonalInfo").then((module) => ({
    default: module.PersonalInfo,
  }))
);
const PhoneNumbers = React.lazy(() =>
  import("../../component/profile/PhoneNumbers").then((module) => ({
    default: module.PhoneNumbers,
  }))
);
...
const ProfileSectionCard = ({
  ...
  <section className="bg-white shadow-xl  rounded-xl overflow-hidden">
    <header className="flex items-center gap-3 py-5 px-1 sm:p-6 border-b border-neutral-200">
    ...
    <div className="py-5 px-1 sm:p-6">{children}</div>
  </section>
);
    ...
    <div className="bg-neutral-100 min-h-screen font-primary text-neutral-700">
      ...
      <main className="container mx-auto px-1 py-8 sm:py-12">
        <div className="max-w-5xl mx-auto flex flex-col gap-8 sm:gap-10">
          <Suspense
            fallback={<LoadingSpinner text="Chargement des informations..." />}
          >
            <ProfileSectionCard
          ...
          <Suspense
            fallback={<LoadingSpinner text="Chargement des numéros..." />}
          >
            <ProfileSectionCard
          ...
          <Suspense
            fallback={<LoadingSpinner text="Chargement des adresses..." />}
          >
            <ProfileSectionCard
