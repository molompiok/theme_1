...
export function DisplayPrice({ product }: { product: ProductType }) {
  return (
    <div className="pl-2 flex justify-start list-product-breakpoint-4:items-center gap-1  items-start list-product-breakpoint-4:flex-row flex-col">
      <h1 className=" line-through font-light text-clamp-xs text-red-500 whitespace-nowrap list-product-breakpoint-4:block hidden ">
        {product.barred_price} {product.currency}
      </h1>
      <div className="size-1 list-product-breakpoint-4:block hidden rounded-4xl bg-black" />
      <h1 className=" whitespace-nowrap text-clamp-base text-black/60">
